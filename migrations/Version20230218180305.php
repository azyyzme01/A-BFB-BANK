 ...
 */
final class Version20230218180305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rdv (id INT AUTO_INCREMENT NOT NULL, services_id INT DEFAULT NULL, date DATE NOT NULL, raison VARCHAR(255) NOT NULL, heure VARCHAR(255) NOT NULL, INDEX IDX_10C31F86AEF5A6C1 (services_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
