...
class TypeController extends AbstractController
{
    ...
    #[Route('/aff', name: 'app_type_frt', methods: ['GET'])]
    public function indexf(TypeRepository $typeRepository): Response
    {
        return $this->render('type/affichagetb.html.twig', [
            'types' => $typeRepository->findAll(),
        ]);
    }
    ...
    #[Route('/sh{id}', name: 'app_type_show', methods: ['GET'])]
    ...
    #[Route('/{id}', name: 'app_type_showb', methods: ['GET'])]
    public function showb(Type $type): Response
    {
        return $this->render('type/showback.html.twig', [
            'type' => $type,
        ]);
    }
