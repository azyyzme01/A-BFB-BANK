...
class ServiceController extends AbstractController
{
    ...
    public function new(Request $request, ServiceRepository $serviceRepository,FlashyNotifier $flashy): Response
    {
        $service = new Service();
    ...
    public function edit(Request $request, Service $service, ServiceRepository $serviceRepository,FlashyNotifier $flashy): Response
    {
        $form = $this->createForm(Service1Type::class, $service);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, Service $service, ServiceRepository $serviceRepository,FlashyNotifier $flashy): Response
    {
